...
const DICT: Record<Lang, Record<string, string>> = {
  vi: {
    ...
    aiErrNoKey: 'Chưa cấu hình OpenAI API key (xem src/ai/config.ts — sẽ cập nhật sau).',
    aiErrCall: 'Gọi OpenAI thất bại. Kiểm tra mạng/key rồi thử lại.',
  ...
  ja: {
    ...
    aiGenerating: '生成中…',
    aiGenLoading: 'AI生成中',
    aiErrNoKey: 'OpenAI APIキーが未設定です（src/ai/config.ts 参照 — 後で設定予定）。',
    aiErrCall: 'OpenAI呼び出しに失敗しました。ネットワーク／キーを確認してください。',
