...
const DICT: Record<Lang, Record<string, string>> = {
  vi: {
    ...
    commitRename: 'Đổi tên: {name}',
    commitDuplicate: 'Duplicate: {name}',
    ...
    // ── Tìm kiếm + phân trang ──
    fmSearch: 'Tìm kiếm',
    fmSearchPlaceholder: 'Tìm theo tên bệnh viện, tên kịch bản, người tạo… (vd: bệnh viện_kịch bản)',
    ...
    dmRestore: 'Khôi phục thành phiên bản mới',
  ...
  ja: {
    ...
    fmDuplicate: '複製',
    commitRename: '名称変更: {name}',
    commitDuplicate: '複製: {name}',
    fmUpload: 'アップロード',
    fmUploading: 'アップロード中…',
    fmNew: '新規フロー作成',
    fmRefresh: '更新',
    ...
    // ── 検索 + ページネーション ──
    fmSearch: '検索',
    fmSearchPlaceholder: '施設名・シナリオ名・作成者で検索…（例：施設名_シナリオ名）',
