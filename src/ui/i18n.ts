...
const DICT: Record<Lang, Record<string, string>> = {
  vi: {
    ...
    // ── AI Chat (trợ lý sửa flow bằng hội thoại) ──
    aiChatOpen: 'Trợ lý AI',
    aiChatTitle: 'Trợ lý AI',
    aiChatSubtitle: 'Chỉnh sửa flow này bằng hội thoại',
    aiChatGreeting:
      'Xin chào! Hãy mô tả phần bạn muốn thêm/sửa ở flow đang mở — bằng tiếng Việt hoặc tiếng Nhật.',
    aiChatPlaceholder: 'Nhập yêu cầu… (vd: thêm câu hỏi xác nhận số điện thoại sau node chào)',
    aiChatSendSuffix: 'để gửi',
    aiChatSend: 'Gửi',
    aiChatStop: 'Dừng',
    aiChatProposed: 'Thay đổi đề xuất — {n}',
    aiChatApply: 'Áp dụng',
    aiChatReject: 'Bỏ',
    aiChatApplied: 'Đã áp dụng',
    aiChatRejected: 'Đã bỏ',
    aiChatDeleteWarn: '⚠ {n} mục sẽ bị XOÁ — kiểm tra kỹ trước khi áp dụng.',
    aiChatWiringWarn: '⚠ Flow đang mở còn {n} chỗ chưa nối dây',
    aiChatNoChanges: 'AI không đề xuất thay đổi nào.',
    aiChatParseErr: 'Không đọc được phản hồi của AI. Hãy thử lại hoặc nói rõ hơn.',
    aiChatApplyErr: 'Áp dụng thay đổi thất bại.',
    aiChatNoFlow: 'Chưa mở flow nào để chỉnh sửa.',
    aiOpAddNode: 'Thêm node "{label}" ({type})',
    aiOpUpdateNode: 'Sửa node "{label}"',
    aiOpRemoveNode: 'Xoá node "{label}"',
    aiOpAddEdge: 'Nối {from} → {to}',
    aiOpRemoveEdge: 'Bỏ nối {from} → {to}',
    // Nhánh
    ...
    edgeWaypointTitle: 'Kéo dây ngang lên/xuống · double-click để trả về mặc định',
    ...
    // ── Node 分岐ロジック (CS) ──
    clCondCount: 'Số điều kiện',
    clCondition: 'Điều kiện',
    clData: 'Dữ liệu',
    clHearing: 'Nội dung hỏi',
    clPhone: 'Số điện thoại',
    clDatetime: 'Ngày giờ gọi đến',
    clIncoming: 'Số gọi đến',
    clAnswered: 'Số khách đọc',
    clDate: 'Ngày',
    clDay: 'Thứ',
    clTime: 'Giờ',
    clWhichHearing: 'Hearing Node',
    clValues: 'Value',
  ...
  ja: {
    ...
    aiChatSubtitle: 'このフローを会話で編集',
    aiChatGreeting:
      'こんにちは。今開いているフローについて、追加・修正したい内容を日本語またはベトナム語で指示してください。',
    aiChatPlaceholder: '修正内容を入力…（例：オープニング案内のあとに電話番号を確認する質問を追加）',
    aiChatSendSuffix: 'で送信',
    aiChatSend: '送信',
    aiChatStop: '停止',
    aiChatProposed: '提案された変更 — {n}件',
    aiChatApply: '適用する',
    aiChatReject: '破棄',
    aiChatApplied: '適用済み',
    aiChatRejected: '破棄しました',
    aiChatDeleteWarn: '⚠ {n}件が削除されます — 適用前にご確認ください。',
    aiChatWiringWarn: '⚠ 開いているフローに未接続の分岐が {n} 件あります',
    aiChatNoChanges: 'AIからの変更提案はありません。',
    aiChatParseErr: 'AIの応答を解釈できませんでした。もう一度お試しください。',
    aiChatApplyErr: '変更の適用に失敗しました。',
    aiChatNoFlow: '編集するフローが開かれていません。',
    aiOpAddNode: 'ノード追加 「{label}」（{type}）',
    aiOpUpdateNode: 'ノード更新 「{label}」',
    aiOpRemoveNode: 'ノード削除 「{label}」',
    aiOpAddEdge: '接続 {from} → {to}',
    aiOpRemoveEdge: '接続削除 {from} → {to}',
    // Nhánh
    addBranch: '分岐を追加',
    deleteBranch: '分岐を削除',
    ...
    edgeWaypointTitle: '横線を上下にドラッグ · ダブルクリックで既定に戻す',
