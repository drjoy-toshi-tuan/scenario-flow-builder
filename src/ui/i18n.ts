...
const DICT: Record<Lang, Record<string, string>> = {
  vi: {
    ...
    fmConnectDesc:
      'Nhập fine-grained token có quyền Contents: Read/Write trên repo này để đọc/ghi file YAML.',
    fmTokenLabel: 'GitHub Token',
    fmTokenPlaceholder: 'github_pat_…',
  ...
  ja: {
    ...
    fmConnectDesc:
      'このリポジトリで Contents: Read/Write 権限を持つ fine-grained トークンを入力してください。',
