...
const DICT: Record<Lang, Record<string, string>> = {
  vi: {
    ...
    aiRoleScript: 'Kỹ sư IVR Brekeke: sinh/sửa script phân tích câu trả lời của người gọi.',
    aiRolePrompt: 'Chuyên gia prompt: sinh/sửa prompt phân tích câu trả lời cho node OpenAI.',
    aiQuestionNode: 'Node câu hỏi (Announce / Interaction)',
    aiQuestionNodeNone: '— Không chọn —',
    aiContextNone: 'Không có',
    aiContextHint: 'Toàn bộ YAML + code/prompt hiện tại được gửi kèm làm ngữ cảnh.',
  ...
  ja: {
    ...
    aiGenerate: 'AI生成・修正',
    aiRoleScript: 'Brekeke IVRエンジニア：発信者の回答を解析するスクリプトを生成・修正。',
    aiRolePrompt: 'プロンプト専門家：OpenAIノードの回答解析プロンプトを生成・修正。',
    aiQuestionNode: '質問ノード（アナウンス／インタラクション）',
    aiQuestionNodeNone: '— 選択しない —',
    aiContextNone: 'なし',
    aiContextHint: '現在のYAMLとコード／プロンプトもコンテキストとして送信されます。',
    aiUserPrompt: '指示内容',
