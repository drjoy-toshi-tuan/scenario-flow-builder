...
const DICT: Record<Lang, Record<string, string>> = {
  vi: {
    ...
    csDmTitle: 'Quản lý Flow Diagram (シナリオ設計書)',
    csDmSubtitleFacilities: 'Chọn bệnh viện để xem danh sách シナリオ設計書.',
    csDmSubtitleScenarios: 'Chọn kịch bản để xem danh sách phiên bản bản thiết kế.',
    csDmSubtitleVersions: 'Danh sách phiên bản シナリオ設計書 (mới nhất ở trên).',
    ...
    gsGroupSchedule: 'Lịch hoạt động',
